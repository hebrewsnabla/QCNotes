...
6,10,15,19,24,29,32,41\\
\ex{6}
From Problem 17-5, we have
\begin{equation}\label{key}
\ev{E} = -\dfrac{\hbar\gamma B_z}{2}\tanh\dfrac{\hbar\gamma B_z}{2\kB T}
\end{equation}
Since
\begin{equation}\label{key}
\tanh x \ra 1 \;\text{as}\; x\ra \infty \qquad \tanh x \ra 0 \;\text{as}\; x\ra 0
\end{equation}
we have
\begin{equation}\label{key}
\ev{E} \ra -\dfrac{\hbar\gamma B_z}{2} \;\text{as}\; T \ra 0 \qquad  \ev{E} \ra 0 \;\text{as}\; T\ra \infty
\end{equation}

\ex{10}
\begin{align}
\ev{E} &= \kB T^2\qty(\pdv{\ln Q}{T})_{N,V} = \kB T^2 \dfrac{N}{T} = N\kB T
\end{align}
while the 3-D $ \ev{E} $ is $ \dfrac{3}{2}N\kB T $, because each dimension contributes $ \dfrac{1}{2}N\kB T $.
