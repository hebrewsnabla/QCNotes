...
\title{\textbf{Theoretical and Physical Organic Chemistry}\\Homework III}
\author{王石嵘
\vspace{5pt}\\
161240065\\
...
K_{a} = \dfrac{[\ce{H_3O^+}][\ce{H_2O}]}{[\ce{H_3O^+}]} = [\ce{H_2O}]
\end{equation}
\begin{equation}\label{key}
\mathrm{p}K_a = -\lg [\ce{H_2O}] = -\lg 55.5 = -1.74
\end{equation}

\begin{equation}\label{key}
K_{a} = \dfrac{[\ce{H_3O^+}][\ce{OH^-}]}{[\ce{H_2O}]} = \dfrac{K_w}{[\ce{H_2O}]}
\end{equation}
\begin{equation}\label{key}
\mathrm{p}K_a = -\qty(\lg K_w - \lg[\ce{H_2O}]) = -(-14 - 1.74) = 15.74
\end{equation}
